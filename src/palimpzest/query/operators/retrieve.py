...
class RetrieveOp(PhysicalOperator):
    ...
    def __call__(self, candidate: DataRecord) -> DataRecordSet:
        ...
        if isinstance(self.index, Collection):
            ...
            # uses_sentence_transformer_embedding_fcn = isinstance(self.index._embedding_function, SentenceTransformerEmbeddingFunction) or isinstance(self.index._embedding_function, HuggingFaceEmbeddingFunction)
            ##########################
